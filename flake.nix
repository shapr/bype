  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            bype = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        bype-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        bype-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        bype-audit = craneLib.cargoAudit {
      ...
      apps = forAllSystems ({system, ...}: {
        bype = {
          type = "app";
          program = "${self.packages.${system}.bype}/bin/bype";
        };
        default = self.apps.${system}.bype;
      });
